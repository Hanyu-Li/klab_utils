...
def large_local_to_cloud(data_path, cloud_path, dtype=None, multi=False,z_step=64,
         layer_type=None, resolution=None, scale=0):
...
def main():
    ...
    if args.labels is not None: 
        ...
        if not args.large:
            ...
            large_local_to_cloud(args.labels, labels_cloud_path, dtype='uint32', multi=args.multi, z_step=args.z_step,
