...
def main():
  ...
  parser.add_argument(
      'input', type=str, help='dir containing the stack, with *[id].tif')
  parser.add_argument('--output', default='.')
  parser.add_argument('--trackem2_index', default=False,
                      help='wether the tiff stack uses trackem2 style "*z[id].0.tif" indexing ')
